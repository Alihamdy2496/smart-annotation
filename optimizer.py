...
def optimize(
        ...
        try:
            ...
            for batch_num in range(num_batches):
                ...
                x_projected = project_to_nonoverlap(
                    ...
                    temp_fixed,
                    max_proj_iters=500,
                    min_separation=0.5,  # Stage 1: loose separation
                )
    ...
    # ==================== STAGE 2: BATCH REFINEMENT (min_separation=1.5) ====================
    print("\n" + "=" * 80)
    print("STAGE 2: Batch-by-batch refinement with min_separation=1.5")
    print("=" * 80)
    ...
    # ==================== STAGE 3: FINAL TIGHTENING (min_separation=1.5) ====================
    print("\n" + "=" * 80)
    print("STAGE 3: Final tightening with min_separation=1.5")
    print("=" * 80)
